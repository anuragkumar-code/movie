...
<h3>1). User is required to create new database and setup .env file, and then run the migration command.</h3>
<h3>2). User is required to sign up first, for the access of this web application.</h3>
